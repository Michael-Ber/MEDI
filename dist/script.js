...
window.addEventListener('DOMContentLoaded', () => {
  ...
  tabs('.intro__tablink', '.intro__tab-content > div', 'intro__tablink_active', 'intro__tab-content_active'); // INTRO TABS END
  // INTRO CAROUSEL
  ...
  tabs('.news__tab-item', '.news__tab-content', 'news__tab-item_active', 'news__tab-content_active'); // NEWS TABS END
});
